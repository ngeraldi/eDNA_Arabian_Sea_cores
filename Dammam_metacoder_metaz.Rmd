...
heat_tree(tax, 
          ...
          node_color_interval = c(-0.01,0.01), # The range of `log2_median_ratio` to display
          node_label_size_range = c(0.020, 0.028),
...
#     data.table::fwrite(tab2,paste(dir,plot_file,"/metacoder_metaz.csv",sep=""),row.names=F, sep=",")
```
